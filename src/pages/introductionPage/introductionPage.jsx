  ...
  return (
    <div className={styles.layout} id="home">
      <div className={styles.content}>
        ...
        <p>
          I am a young graduate who is passionate about IT. I want to start my
          carrer in this area!
        </p>
        <div className={styles.socialMedia}>
          <a href="https://www.facebook.com/niculita.andrei.7" target="_blank">
            <FontAwesomeIcon className={styles.facebook} icon={faFacebook} />
          </a>
          <a
            href="https://www.linkedin.com/in/andrei-niculita-236237221/"
            target="_blank"
          >
            <FontAwesomeIcon className={styles.linkedin} icon={faLinkedin} />
          </a>
          <a href="https://github.com/NicAndrei2000" target="_blank">
            <FontAwesomeIcon className={styles.github} icon={faGithub} />
          </a>
        </div>
      </div>
      <div className={styles.myImage}>
        <img className={styles.image} src={personalImg} alt="Doesn't load" />
      </div>
    </div>
  );
}
